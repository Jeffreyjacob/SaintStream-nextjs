  ...
  return (
    <div className=' h-full bg-primary-500 border-t-[1px] border-[#4d4d4d] text-white'>
      <div className='wrapper'>
        <div className='flex flex-col md:flex-row justify-center md:justify-between mb-10'>
          ...
          <div className='flex flex-col h-full  md:flex-col-reverse  '>
              <div className='flex gap-2  mb-5 md:mb-0 md:items-start'>
              <Instagram />
               <Facebook/>
               <Twitter/>
               <Github/>
        ...
        <div className='flex flex-col w-full md:flex-row text-gray-400 justify-center text-[10px] md:justify-between gap-2 md:gap-0'>
